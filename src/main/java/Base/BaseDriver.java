...
public class BaseDriver 
{
   ...
   {
	   htmlreporter = new ExtentHtmlReporter("D:\\Selenium\\new eclipse may 2020-workspace\\MYPOM\\Reports\\abc.html");     	
 	 ...
 	 extentreport.attachReporter(htmlreporter);    	 
	   FileInputStream fis = new FileInputStream("D:\\Selenium\\new eclipse may 2020-workspace\\ISC_helpdesk\\src\\main\\java\\properties\\config.properties");
       config.load(fis);
       FileInputStream objectfis = new FileInputStream("D:\\Selenium\\new eclipse may 2020-workspace\\ISC_helpdesk\\src\\main\\java\\properties\\object.properties");
